...
class PDFViewer:
    def __init__(self, root = None):
        ...
        self.master.iconbitmap(self.master, PATH_PROG + '/image/icons/pdf.ico')
        ...
        self.uparrow_icon = PhotoImage(file=PATH_PROG + '/image/48x48/UpArrowIcon.png')
        self.downarrow_icon = PhotoImage(file=PATH_PROG + '/image/48x48/DownArrowIcon.png')
