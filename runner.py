...
class Console(Frame):
    ...
    def __init__(self, parent, _locals, exit_callback):
        ...
        self.text = ConsoleText(self, wrap=WORD)
        ...
        self.text.bind('<Escape>', exit_callback)
...
class RunPython:
    ...
    def run_python(self):
        ...
        console = Console(root, {}, lambda _: root.destroy())
...
##    root.iconbitmap(PATH_PROG + '/image/python.ico')
##    root.title(lg('run_python'))
